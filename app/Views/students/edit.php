...
<div class="form-container">
    <h2>Edit Student</h2>
    <form method="post" action="<?= site_url('students/update/' . $student['id']) ?>" enctype="multipart/form-data">
        ...
        <?php if (!empty($student['profileimg'])): ?>
            <img class="preview" src="<?= base_url('uploads/' . $student['profileimg']) ?>" alt="Current Profile Picture">
        <?php endif; ?>
